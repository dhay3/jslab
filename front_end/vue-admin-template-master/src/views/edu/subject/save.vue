    ...
    <el-form label-width="120px">
      <el-form-item label="excel模板">
        <el-tag>
          ...
          <a :href="'https://gulied-program.oss-cn-beijing.aliyuncs.com/template.xlsx'">下载模版</a>
        </el-tag>
      </el-form-item>
...
<script>
  export default {
    ...
    data() {
      return {
        //直接调用后端api,无需引入js文件
        BASE_API: "http://localhost:8080/", // 接口API地址
        fileUploadBtnText: '上传模板到OSS', // 按钮文字, 可以将值直接写死
